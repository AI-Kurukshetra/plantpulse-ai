...
export const navigation = [
  // Must-have features (1-8) followed by important features (9-20/22/23) in project priority order.
  { href: '/dashboard' as Route, label: 'Real-time Monitoring', roles: ['admin', 'plant_manager', 'technician'] as UserRole[] },
  // Energy KPIs/charts are currently surfaced in the real-time monitoring dashboard.
  { href: '/dashboard' as Route, label: 'Energy Consumption', roles: ['admin', 'plant_manager', 'technician'] as UserRole[] },
  ...
  // Sustainability page contains emissions metrics and scoring benchmark views.
  { href: '/sustainability' as Route, label: 'Emissions Tracking', roles: ['admin', 'plant_manager'] as UserRole[] },
  { href: '/analytics' as Route, label: 'Production Efficiency', roles: ['admin', 'plant_manager'] as UserRole[] },
  { href: '/sustainability' as Route, label: 'Sustainability Scoring', roles: ['admin', 'plant_manager'] as UserRole[] },
  { href: '/alerts' as Route, label: 'Anomaly Detection', roles: ['admin', 'plant_manager', 'technician'] as UserRole[] },
  // Remaining must-have features from project-definition.
  ...
  { href: '/admin' as Route, label: 'Control Center', roles: ['admin'] as UserRole[] },
